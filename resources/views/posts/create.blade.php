            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="location_found" class="block mt-1 w-full" type="text" name="location_found" :value="old('location_found')" required />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="date_found" class="block mt-1 w-full" type="date" name="date_found" :value="old('date_found')" max="{{ date('Y-m-d') }}" required />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="contact_phone" class="block mt-1 w-full" type="text" name="contact_phone" :value="old('contact_phone')" required />
                    ...
                    <div class="flex items-center justify-end mt-6 gap-4">
                        <a href="{{ route('home') }}" class="text-sm text-gray-600 underline">Cancel</a>
